...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listWidget.setGeometry(QtCore.QRect(20, 20, 311, 521))
        self.listWidget.setObjectName("listWidget")
        self.listWidget_2 = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget_2.setGeometry(QtCore.QRect(350, 20, 431, 521))
        self.listWidget_2.setObjectName("listWidget_2")
        self.BtnGetFines = QtWidgets.QPushButton(self.centralwidget)
        self.BtnGetFines.setGeometry(QtCore.QRect(80, 550, 151, 32))
        self.BtnGetFines.setObjectName("BtnGetFines")
        self.BtgEbatShtrule1 = QtWidgets.QPushButton(self.centralwidget)
        self.BtgEbatShtrule1.setGeometry(QtCore.QRect(540, 550, 161, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BtgEbatShtrule1.setText(_translate("MainWindow", "Ебать штрулей"))
